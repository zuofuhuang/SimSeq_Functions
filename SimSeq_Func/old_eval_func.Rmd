...
# 
# # We have 2900 + dates. Here we only extract day sequences with a corresponding biweekly survey. If we want all the days, we can replace data with wide_data_2 in creating `new` dataset.
# new <- data %>%
