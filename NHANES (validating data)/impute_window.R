...
set.seed(460)
accel_final <- read.csv("dat2_s4k10_updated.csv")[,2:1432]
imputed3 <- impute(accel_final, 60)
imputed_seqs_s4k10_updated <- cbind(accel_final, imputed3)
write.csv(imputed_seqs_s4k10_updated, "imputed_seqs_s4k10_updated.csv")
